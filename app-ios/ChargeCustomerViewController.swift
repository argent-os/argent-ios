...
class ChargeCustomerViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating, UISearchBarDelegate, ChargeCustomerSearchControllerDelegate {
    ...
    var customSearchController: ChargeCustomerSearchController!

    var chargeAmount : String?
    let chargeType = NSUserDefaults.standardUserDefaults().stringForKey("chargeType")!
