...
class CreditCardEntryModalViewController: UIViewController, UITextFieldDelegate {
...
extension CreditCardEntryModalViewController: STPPaymentCardTextFieldDelegate {
