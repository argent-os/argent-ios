...
class MenuChildViewControllerOne: UIViewController, IndicatorInfoProvider {
    ...
    func configureView() {
        ...
        let str1 = adjustAttributedString("CREATE CHARGE", spacing: 1, fontName: "MyriadPro-Regular", fontSize: 13, fontColor: UIColor.whiteColor(), lineSpacing: 0.0, alignment: .Left)
        ...
        let str2 = adjustAttributedString("CREATE PLAN", spacing: 1, fontName: "MyriadPro-Regular", fontSize: 13, fontColor: UIColor.whiteColor(), lineSpacing: 0.0, alignment: .Left)
