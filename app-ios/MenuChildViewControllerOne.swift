...
class MenuChildViewControllerOne: UIViewController, IndicatorInfoProvider {
    ...
    func configureView() {
        ...
        let str1 = adjustAttributedString("ACCEPT PAYMENT", spacing: 1, fontName: "SFUIText-Regular", fontSize: 12, fontColor: UIColor.whiteColor(), lineSpacing: 0.0, alignment: .Left)
        ...
        let str2 = adjustAttributedString("CREATE BILLING PLAN", spacing: 1, fontName: "SFUIText-Regular", fontSize: 12, fontColor: UIColor.whiteColor(), lineSpacing: 0.0, alignment: .Left)
